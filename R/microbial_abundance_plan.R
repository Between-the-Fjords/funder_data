...
list(
  ...
  tar_target(
    ...
    command = get_file(
      ...
      path = "raw_data/microbial_abundance",
      remote_path = "xii-xvi_soil_microbes_fungi/FUNDER_raw_microbial_abundance/"
    )
  ),
  ...
  tar_target(
    ...
    command = get_microbial_abundance_from_osf(
      group = "bacteria",
      path = "raw_data/microbial_abundance/bacteria/"
    )
  ),
  ...
  tar_target(
    ...
    command = get_microbial_abundance_from_osf(
      group = "fungi",
      path = "raw_data/microbial_abundance/fungi/"
    )
  ),
