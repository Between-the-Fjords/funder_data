### Clean root data (legacy workflow)
...
root_plan_old <- list(
  ...
  tar_target(
    ...
    command = clean_ric_root_biomass_old(root_ric_biomass_raw)
  ),
  ...
  tar_target(
    ...
    command = clean_ric_root_traits_old(root_traits_F_G_B_raw, root_traits_ric_FAU4FB_raw, root_traits_ric_GF_GB_FB_raw, root_traits_block_4_raw)
  ),
  ...
  tar_target(
    ...
    command = clean_C_FGB_traits_old(root_traits_C_FGB_2023_raw)
  ),
  ...
  tar_target(
    ...
    command = clean_ric_depth_old(ric_depth_raw)
  ),

  tar_target(
    name = root_traits_clean_old,
    command = join_root_traits_old(root_ric_biomass_clean, root_traits_ric_joined, root_traits_C_FGB_clean, ric_depth_clean)
  ),
  ...
  tar_target(
    ...
    command = apply_operator_correction(root_traits_clean_old, reference_operator = "Michaela")
  ),
  ...
  tar_target(
    ...
    command = clean_root_biomass_old(root_biomass_raw, funder_meta)
  )
