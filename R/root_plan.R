...
root_plan <- list(
  ...
  tar_target(
    ...
    command = get_file(
      node = "tx9r2",
      file = "ii_FUNDER_raw_Root_Weight_2023_C_FGB.csv",
      path = here::here("raw_data", "roots"),
      remote_path = "i-viii_vegetation/ii_root_biomass_productivity_and_traits"
    ),
    format = "file"
  ),
  ...
  tar_target(
    ...
    command = get_file(
      node = "tx9r2",
      file = "ii_FUNDER_raw_root_weight_rest_2022.csv",
      path = here::here("raw_data", "roots"),
      remote_path = "i-viii_vegetation/ii_root_biomass_productivity_and_traits"
    ),
    format = "file"
  ...
  tar_target(
    ...
    command = get_file(
      node = "tx9r2",
      file = "ii_FUNDER_raw_Roots_Traits_2023_C_FGB.csv",
      path = here::here("raw_data", "roots"),
      remote_path = "i-viii_vegetation/ii_root_biomass_productivity_and_traits"
    ),
    format = "file"
  ...
  tar_target(
    ...
    command = get_file(
      node = "tx9r2",
      file = "ii_FUNDER_raw_ric_double-removal_root_traits_2024.txt",
      path = here::here("raw_data", "roots"),
      remote_path = "i-viii_vegetation/ii_root_biomass_productivity_and_traits"
    ),
    format = "file"
  ...
  tar_target(
    ...
    command = get_file(
      node = "tx9r2",
      file = "ii_FUNDER_leo_and_miska_scan_results_all.txt",
      path = here::here("raw_data", "roots"),
      remote_path = "i-viii_vegetation/ii_root_biomass_productivity_and_traits"
    ),
    format = "file"
  ...
  tar_target(
    ...
    command = get_file(
      node = "tx9r2",
      file = "ii_FUNDER_raw_root_biomass_2021.xlsx",
      path = here::here("raw_data", "roots"),
      remote_path = "i-viii_vegetation/ii_root_biomass_productivity_and_traits"
    ),
    format = "file"
  ...
  tar_target(
    ...
    command = save_csv(
      ...
      name = "ii_FUNDER_clean_root_biomass_productivity_traits_2021-2022.csv"
    ),
    format = "file"
  )
