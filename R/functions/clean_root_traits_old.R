# clean root trait data (legacy workflow)

# clean ric root biomass
clean_ric_root_biomass_old <- function(root_ric_biomass_raw) {
...
clean_ric_root_traits_old <- function(root_traits_F_G_B_raw, root_traits_ric_FAU4FB_raw, root_traits_ric_GF_GB_FB_raw, root_traits_block_4_raw) {
...
clean_C_FGB_traits_old <- function(root_traits_C_FGB_2023_raw) {
...
join_root_traits_old <- function(root_ric_biomass_clean, root_traits_ric_joined, root_traits_C_FGB_clean, ric_depth_clean) {
